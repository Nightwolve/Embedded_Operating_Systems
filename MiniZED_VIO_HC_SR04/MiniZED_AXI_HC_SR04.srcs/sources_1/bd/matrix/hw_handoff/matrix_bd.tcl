...
proc create_root_design { parentCell } {
  ...
  set matrix_out [ create_bd_port -dir O matrix_out ]
  set sonar_echo [ create_bd_port -dir I sonar_echo ]
  set sonar_trig [ create_bd_port -dir O sonar_trig ]

  # Create instance: HC_SR04_0, and set properties
  set block_name HC_SR04
  set block_cell_name HC_SR04_0
  if { [catch {set HC_SR04_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net HC_SR04_0_centimeter [get_bd_pins HC_SR04_0/centimeter] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net HC_SR04_0_sonar_trig [get_bd_ports sonar_trig] [get_bd_pins HC_SR04_0/sonar_trig]
  connect_bd_net -net gpio2_io_i_0_1 [get_bd_ports btns] [get_bd_pins axi_gpio_0/gpio2_io_i]
  connect_bd_net -net matrix_0_led_out [get_bd_ports matrix_out] [get_bd_pins matrix_0/led_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins HC_SR04_0/clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins matrix_0/clk_in] [get_bd_pins matrix_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins matrix_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net sonar_echo_1 [get_bd_ports sonar_echo] [get_bd_pins HC_SR04_0/sonar_echo]

...
HD_PWD='C:/Users/Bart/Documents/GitHub/Embedded_Operating_Systems/Embedded_Operating_Systems/MiniZED_VIO_HC_SR04/MiniZED_AXI_HC_SR04.runs/matrix_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrix_xbar_0.tcl

proc create_ipi_design { offsetfile design_name } {
	...
	set S00_AXI_ws2812_INIT_AXI_TXN [ create_bd_port -dir I S00_AXI_ws2812_INIT_AXI_TXN ]
	set S00_AXI_ws2812_ERROR [ create_bd_port -dir O S00_AXI_ws2812_ERROR ]
	set S00_AXI_ws2812_TXN_DONE [ create_bd_port -dir O S00_AXI_ws2812_TXN_DONE ]
...
connect_bd_intf_net [get_bd_intf_pins slave_0/S_AXI ] [get_bd_intf_pins matrix_ip_0/S00_AXI_ws2812]
	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins slave_0/ACLK] [get_bd_pins matrix_ip_0/S00_AXI_ws2812_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins slave_0/ARESETN] [get_bd_pins matrix_ip_0/S00_AXI_ws2812_ARESETN]
	connect_bd_net -net init_axi_txn_00 [get_bd_ports S00_AXI_ws2812_INIT_AXI_TXN] [get_bd_pins matrix_ip_0/S00_AXI_ws2812_INIT_AXI_TXN]
	connect_bd_net -net error_00 [get_bd_ports S00_AXI_ws2812_ERROR] [get_bd_pins matrix_ip_0/S00_AXI_ws2812_ERROR]
	connect_bd_net -net txn_done_00 [get_bd_ports S00_AXI_ws2812_TXN_DONE] [get_bd_pins matrix_ip_0/S00_AXI_ws2812_TXN_DONE]

...
# Test: S00_AXI_ws2812
set wdata_s00_axi_ws2812 [get_init_data 0]
create_hw_axi_txn w_s00_axi_ws2812_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_s00_axi_ws2812}
create_hw_axi_txn r_s00_axi_ws2812_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_s00_axi_ws2812_addr
run_hw_axi w_s00_axi_ws2812_addr
run_hw_axi r_s00_axi_ws2812_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_s00_axi_ws2812_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 1 0 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - S00_AXI_ws2812"
} else {
	puts "Data comparison test fail for - S00_AXI_ws2812, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}

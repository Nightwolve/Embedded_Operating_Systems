# Runtime Tcl commands to interact with - ws2812_ip_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/ws2812_ip_v1_0_include.tcl
...
# Test: M00_AXI_ws2812
set wdata_m00_axi_ws2812 [get_init_data 0]
create_hw_axi_txn w_m00_axi_ws2812_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_m00_axi_ws2812}
create_hw_axi_txn r_m00_axi_ws2812_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_m00_axi_ws2812_addr
run_hw_axi w_m00_axi_ws2812_addr
run_hw_axi r_m00_axi_ws2812_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_m00_axi_ws2812_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 1 0 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - M00_AXI_ws2812"
} else {
	puts "Data comparison test fail for - M00_AXI_ws2812, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
